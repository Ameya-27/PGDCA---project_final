...
if (isset($_SESSION['username']) && isset($_SESSION['user_master_id'])) {
    ...
    <div class="app">
        ...
        $result = mysqli_query($conn, $query);*/
                                            ...
                                            ?>
                                                <h1 id="h1id">Evaluation Report</h1>
                                                ...
                                                <table id="table" class="table-success table-bordered custom" style="width: 45rem;">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th scope="col" title="Overall Score of Manger's Evaluation in Percentage ">M.Overall Score (in %)</th>
                                                            <th scope="col" title="Overall Score of Employee's Self-Evaluation in Percentage">E.Overall Score (in %)</th>
                                                            <th scope="col" title="Difference Between the employee and manager's evaluations in Percentage. Red Means Manager Score is less than employee score and green means manager score is greater than employee score (%)">Net Difference (in %)</th>
