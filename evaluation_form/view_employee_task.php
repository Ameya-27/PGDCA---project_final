                                    ...
                                    <div class="container d-flex align-items-center" style="min-height: 30vh">
                                        <div class="p-3">
                                            ...
                                            if (mysqli_num_rows($result) > 0 || mysqli_num_rows($result_1) > 0) { ?>
                                                ...
                                                <h1 id="h1id"><?php echo ucfirst($_SESSION['name']) ?>'s Evaluation</h1>
                                                <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/dt/dt-1.11.5/datatables.min.css" />
                                                <table id="table" class="table-secondary table-bordered" style="width: 40rem;">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($rows = mysqli_fetch_assoc($result)) { ?>
                                                            <tr>
                                                                <td><?= $i?></td>
                                                                <td style="display:none"><?= $rows['form_id'] ?></td>
                                                                <td style="display:none"><?= $rows['task_id'] ?></td>
