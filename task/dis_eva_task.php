                            ...
                            <div class="card shadow-lg">
                                <div class="card-body" id="card_body_id">
                                    ...
                                    <form action="employee_manager_insert.php" method="POST">
                                        <label id="label_id"> Evaluation of <?php echo ucfirst($fetch_2['name']); ?> By <?php echo ucfirst($fetch_1['name']); ?></label>
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" style="display:none"><label>Min-Rate</label></th>
                                                        <th scope="col"><label>Your-Rate</label></th>
                                                        <th scope="col" style="display:none"><label>Max-Rate</label></th>
                                                    </tr>
                                                </thead>
                                                <?php
                            ...
                            <div class="card shadow-lg">
                                <div class="card-body" id="card_body_id">
                                    ...
                                    <form action="employee_manager_insert.php" method="POST" class="text-start">
                                        <label id="label_id"> <?php echo ucfirst($fetch_2['name']); ?>'s Evaluation</label>
