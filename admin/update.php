                        ...
                        <div class="col-md-7 col-lg-5 m-h-auto">
                            <div class="card shadow-lg">
                                <div class="card-body" id="card_body_id">
                                    <h3 id="h3id" >Update Form for <?php echo ucfirst("$name"); ?></h3 >
                                    <form action="update_code.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-affix">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" placeholder="name" value="<?php echo ucfirst("$name"); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="dept" name="dept">
                                                ...
                                                ?>
                                                    <option <?php
                                                            ...
                                                            ?> value="<?php echo $row['dept_id']; ?>"> <?php echo strtoupper($row['dept_name']); ?></option>
                                                <?php
                                                endwhile;
                                                ?>
                                            </select>
